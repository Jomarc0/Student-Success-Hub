...
<body>
    ...
    <header>
        <div class="logo">
            <img src="../image/logo.png" alt="Student Success Hub Logo" style="height: 50px;">
            Student Success Hub
        </div>
        <nav class="nav">
    ...
    <form action="FillOutProcessing.php" method="POST" action="FillingOutC.php">
        <section class="form-container">
            <h2 style="text-align: center;margin-bottom: 0;">Individual Interview Form</h2>
            <h5 style="text-align: center;margin-top:0;color:#ff3131">Fields with asterisks(*) are required. Do not submit it unfilled or you will restart.</h5>
            ...
            <div>
                ...
                <div class="form-row">
                    <div class="form-field">
                        ...
                        <input type="text" name="student_sr_code" placeholder="Enter SR-Code">
                    </div>
                    <div class="form-field">
                    ...
                    <div class="form-field">
                        ...
                        <input type="date" class="input-field" name="date" id="dateInput" required>
                ...
                <div class="section">
                    ...
                    <div class="row">
                        <div class="column">
                            <label>Subjects with Lowest Grade</label>
                            <input type="text" name="lowest_grades_subject" placeholder="Type here">
                        </div>
                        <div class="column">
                            <label>Subjects with Highest Grade</label>
                ...
                <div class="section">
                    ...
                    <div class="form-row">
                        <div class="column">
                            ...
                            <label for="business_address">Business Phone</label>
                ...
                <div>
                    <div class="form-row">
                        <div class="column">
                            ...
                            <label type="tel" class="input-label">Landline:</label>
                ...
                <div class="form-section">
                    ...
                    <div class="form-section">
                        ...
                        <div class="form-field">
                            <label for="why">Briefly State Why This Person Influenced You *</label>
                    ...
                    <div class="form-section">
                        ...
                        <div class="checkbox-container">
                            ...
                            <label><input type="checkbox" name="course_selection[]" id="others-checkbox" value="Others, please specify:" onchange="toggleOthersInput()"> Others, please specify:</label>
                        ...
                        <script>
                            function toggleOthersInput() {
                                ...
                                if (othersCheckbox.checked) {
                                    othersInput.style.display = 'inline'; 
                                } else {
                        ...
                        <div class="radio-group">
                            ...
                            <label><input type="radio" name="student_consulted_psychologist"> Yes</label>
                            <label><input type="radio" name="student_consulted_psychologist"> No</label>
                        </div>
                    ...
                    <div class="container">
                        ...
                        <div class="radio-group">
                            ...
                            <label><input type="radio" name="tests_taken"> Yes</label>
                            <label><input type="radio" name="tests_taken"> No</label>
                        </div>
        ...
        <div class="proceed-selection">
            <div class="button-container">
                <button type="submit" name="role" value="SAVE" class="proceed-btn">SAVE</button>
            </div>
        </div>
