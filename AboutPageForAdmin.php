...
<body>
    ...
    <header>
            <div class="logo"><img src="image/bsulogo.png" alt="BSU Logo" class="bsu-logo">
            <img src="image/logo.png" alt="Student Success Hub Logo" style="height: 65px;">
            Student Success Hub
        </div>
        <nav class="nav">
            <a href="HomePageForAdmin.php">Home</a>
            <a href="AboutPageForAdmin.php" class="active">About</a>

            <div class="dropdown">
                <a href="#" class="menu-item">Options</a>
                <div class="dropdown-content">
                    <a href="ImportDB.php">Import DB</a>
                    <a href="ExportDB.php">Export Db</a>
