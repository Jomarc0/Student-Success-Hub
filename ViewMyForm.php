...
// Add this line to link the stylesheet
?>
...
$sql = "SELECT * FROM form WHERE student_email = ?";
...
<div class="form-container">
    ...
    if ($result->num_rows > 0) {
        ...
        echo "<div class='info-section'>";
        echo "<div class='info-item'><span class='info-label'>Parental Status:</span> <span class='info-value'>" . htmlspecialchars($row['parent_status']) . "</span></div>";
        echo "</div>";

        echo "<h3>Guardian Information</h3>";
        echo "<div class='info-section'>";
        echo "<div class='info-item'><span class='info-label'>Guardian:</span> <span class='info-value'>" . htmlspecialchars($row['guardian_name']) . "</span></div>";
        ...
        echo "<div class='info-item'><span class='info-label'>Contact Number:</span> <span class='info-value'>" . htmlspecialchars($row['guardian_emergency_contact_number']) . "</span></div>";
        echo "</div>";
        ...
        echo "<div class='info-item'><span class='info-label'>Where:</span> <span class='info-value'>" . htmlspecialchars($row['counselor_location']) . "</span></div>";
        echo "</div>";
